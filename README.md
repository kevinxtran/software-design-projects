...
- `BMI Calculator Project Part 1`
  - REST and SOAP BMI web service work with C#/.NET projects and client code
- `BMI Calculator Project Part 2`
  - Android BMI application using MVC-style structure and web API integration
- `Directory Management System Project`
  - Java refactoring and implementation work based on object-oriented design corrections and UML class diagrams
- `Online Shopping Store Project`
  - Software architecture documentation, quality attribute scenarios, and C4-style system diagrams
